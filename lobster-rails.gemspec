...
require 'lobster/rails/version'

Gem::Specification.new do |s|
  s.name          = 'lobster-rails'
  s.version       = Lobster::Rails::VERSION
  ...
  s.license       = 'MIT'
  s.files         = ['lib/lobster/rails.rb', 'lib/lobster/rails/version.rb', 'lib/lobster/railtie.rb', 'lib/lobster/rails/lobster_helper.rb']
  s.require_paths = ['lib']
end